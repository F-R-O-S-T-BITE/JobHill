...
export default function ProfileSidebar({
  ...
  return (
    <div className="w-1/5 bg-white shadow-lg flex flex-col h-full">
        ...
        <div className="relative inline-block ">
          {avatarUrl ? (
            <img
              src={avatarUrl}
              alt={displayName}
              className="w-40 h-40 rounded-full border-2 border-[#0353A4] shadow-md"
            />
          ) : (
            <div className="w-40 h-40 rounded-full border-2 border-[#0353A4]  flex items-center justify-center">
             <img className='rounded-full' src="resources/ants/jobmigaShirt.png" alt="" />
            </div>
          )}
        </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          className=" text-center justify-center w-2/3 mb-20 p-2 flex items-center   rounded-lg bg-[#C80404] cursor-pointer hover:bg-red-700 transition-colors text-white"
        >
