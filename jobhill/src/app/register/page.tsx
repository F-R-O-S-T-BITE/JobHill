...
// Import global styles explicitly
import '../globals.css';
    ...
    const FormSection = () => (
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white">
            <div className="max-w-md w-full p-8">
                <h1 className="text-[60px] md:text-[80px] font-black font-inter text-[#0353A4] leading-tight">JOBHILL</h1>
                <p className="text-[16px] font-medium font-poppins text-black mb-10">
        ...
        <div className="flex flex-col md:flex-row min-h-screen w-full bg-white">
            ...
            <div 
                ...
                style={{
                    ...
                    // Force immediate paint with hardware acceleration
